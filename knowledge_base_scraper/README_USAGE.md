...
This folder contains scripts to manage your DevFoolU project database on MongoDB Atlas.
...
- ✅ Reads from the new CSV format (with exact column names matching MongoDB schema)
- ✅ Checks for duplicates using `urlOfProject` before inserting
...
- ✅ Fetches projects from MongoDB one by one
- ✅ Skips projects that already have embeddings
- ✅ Updates MongoDB with generated embeddings
- ✅ Creates rich text from multiple fields for better semantic search
...
[1/150] 🔄 Processing: 'Dress colour changer'
[1/150] ✅ Updated with 384-dim embedding
[2/150] ⏭️  Skipping 'Circuit Solver' (already has embeddings)
...

📊 Summary:
   Total projects: 150
   ✅ Successfully updated: 125
   ⏭️  Skipped (already had embeddings): 25
   ❌ Failed: 0
```
...
- ✅ Fast inference (good for real-time search)
- ✅ Small size (~90MB)
- ✅ 384 dimensions (good balance)
- ✅ Excellent for short texts (project descriptions)
- ✅ Free and open-source
- ✅ Works great with MongoDB vector search

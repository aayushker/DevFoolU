        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto">
              Find similar projects and get AI-powered insights with deep
              semantic analysis
            </p>
          </motion.div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-purple-200 text-xs">
                            Using {results.ai_verdict.model}
                          </p>
                        </div>
                      </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
                  ...
                  <div className="space-y-4">
                    {results.results.map((proj, idx) => (
                      <div
                        key={proj._id}
                        className="rounded-xl border border-white/10 bg-white/[0.03] p-5 hover:border-purple-500/30 transition-all group"
                      >
                        ...
                        {proj.technologiesUsed?.length > 0 && (
                          <div className="mt-3 flex flex-wrap gap-1.5">
                            {proj.technologiesUsed.map((t, i) => (
                              <span
                                key={i}
                                className="text-xs px-2 py-0.5 bg-white/5 border border-white/10 text-gray-500 rounded-md"
                              >
                                {t}
                              </span>
                            ))}
